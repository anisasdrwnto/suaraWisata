...
<html lang="en" style="height: auto;"><head>
  ...
  <style>
    .gallery-img {
      height: 200px;       /* semua gambar tinggi sama */
      object-fit: cover;   /* gambar proporsional, dipotong kalau perlu */
      width: 100%;
    }
  </style>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Sidebar -->
    <div class="sidebar os-host os-theme-light os-host-overflow os-host-overflow-y os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-transition"><div class="os-resize-observer-host observed"><div class="os-resize-observer" style="left: 0px; right: auto;"></div></div><div class="os-size-auto-observer observed" style="height: calc(100% + 1px); float: left;"><div class="os-resize-observer"></div></div><div class="os-content-glue" style="margin: 0px -8px; width: 249px; height: 1310px;"></div><div class="os-padding"><div class="os-viewport os-viewport-native-scrollbars-invisible" style="overflow-y: scroll;"><div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a class="d-block"><?= isset($_SESSION['nama']) ? $_SESSION['nama'] : 'Guest'; ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
             ...
             <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="laporKeluhan.php"class="nav-link">
      ...
      <!-- /.sidebar-menu -->
    </div></div></div><div class="os-scrollbar os-scrollbar-horizontal os-scrollbar-unusable os-scrollbar-auto-hidden"><div class="os-scrollbar-track"><div class="os-scrollbar-handle" style="width: 100%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar os-scrollbar-vertical os-scrollbar-auto-hidden"><div class="os-scrollbar-track"><div class="os-scrollbar-handle" style="height: 60%; transform: translate(0px, 0px);"></div></div></div><div class="os-scrollbar-corner"></div></div>
    <!-- /.sidebar -->
  </aside>

  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="min-height: 1254.67px;">
    <!-- /.content-header -->

        <section class="content">
          <div class="container-fluid">
            <h1>Hello, <?= isset($_SESSION['nama']) ? $_SESSION['nama'] : 'Guest'; ?></h1>
             <div class="container-fluid">
      <div class="row">
        <!-- Item 1 -->
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="card">
            <img src="gambar 1.jpg" 
                 class="card-img-top gallery-img" alt="Gambar 1">
            <div class="card-body">
              <p class="card-text">Deskripsi gambar 1</p>
            </div>
          </div>
        </div>
        <!-- Item 2 -->
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="card">
            <img src="gambar 2.jpg" 
                 class="card-img-top gallery-img" alt="Gambar 2">
            <div class="card-body">
              <p class="card-text">Deskripsi gambar 2</p>
            </div>
          </div>
        </div>
        <!-- Item 3 -->
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="card">
            <img src="gambar 3.jpg" 
                 class="card-img-top gallery-img" alt="Gambar 3">
            <div class="card-body">
              <p class="card-text">Deskripsi gambar 3</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="card">
            <img src="gambar 4.jpg" 
                 class="card-img-top gallery-img" alt="Gambar 4">
            <div class="card-body">
              <p class="card-text">Deskripsi gambar 4</p>
            </div>
          </div>
        </div>
