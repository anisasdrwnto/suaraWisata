      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a class="nav-link" id="messagelogout">
                  <p>Log out</p>
                </a>
              </li>
            </ul>
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Laporan Wisata</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header" style="background:#007bff;">
        <h5 class="modal-title text-white">
          <i class="fas fa-plus-circle mr-2"></i> Tambah Laporan Wisata
        </h5>
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          <label class="col-sm-3 col-form-label font-weight-bold">
            Alamat Pelapor <span class="text-danger">*</span>
          </label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          <label class="col-sm-3 col-form-label font-weight-bold">
            Lokasi Wisata <span class="text-danger">*</span>
          </label>
          <div class="col-sm-9">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <textarea id="isi_laporan" class="form-control" rows="4"
                      placeholder="Masukkan isi laporan"></textarea>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="btnSimpanLaporan">
