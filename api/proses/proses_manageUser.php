...
if ($action == 'read') {
    ...
    $result = mysqli_query($connection, "SELECT id_users, nama, username,password, ROLE FROM users ORDER BY id_users ASC");
    ...
    $result = mysqli_query($connection, "SELECT id_users, nama, username, password, ROLE FROM users WHERE id_users = '$id'");
